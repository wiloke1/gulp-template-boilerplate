  ...
  try {
    ...
    aElement_1.setAttribute(
      ...
      "/collections/"
        ...
        .concat(currentTag ? [currentTag, tag].join("+") : tag)
        .toLowerCase()
    );
 ...
 */
var link_to_add_tag = function (liquid) {
  return (0,
  liquidFilterParamsToTwigFilterParams_1.liquidFilterParamsToTwigFilterParams)({
    liquid: liquid,
    liquidFilterName: "link_to_add_tag",
    twigFilterName: "link_to_add_tag",
  });
};
exports.link_to_add_tag = link_to_add_tag;
